...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      data-inset={inset}
      className={cn(
        "group/dropdown-menu-checkbox-item relative flex cursor-default items-center gap-2.5 rounded-2xl py-2 pr-8 pl-3 text-sm font-medium outline-hidden select-none focus:bg-accent focus:text-accent-foreground focus:**:text-accent-foreground data-inset:pl-9.5 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      checked={checked}
      {...props}
    >
      ...
      >
        <CheckIcon className="opacity-0 transition-opacity duration-200 group-data-[state=checked]/dropdown-menu-checkbox-item:opacity-100" />
      </span>
      {children}
    </DropdownMenuPrimitive.CheckboxItem>
  )
    ...
    >
      ...
      >
        <DropdownMenuPrimitive.ItemIndicator>
          <CheckIcon className="appeals-badge-pop" />
        </DropdownMenuPrimitive.ItemIndicator>
      </span>
      {children}
    </DropdownMenuPrimitive.RadioItem>
